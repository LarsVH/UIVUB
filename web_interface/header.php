                ...
                <div class="header-right">
                    ...
                    <div class="pull-right">
                      <div class="btn-group btn-group-list btn-group-notification">
                        ...
                        <div class="btn-group btn-group-option"><span class=" dropdown-toggle badge">Change status: <button class="btn btn-success btn-rounded">
...
Not available
        ...
        <section>
            <div class="mainwrapper">
                <div class="leftpanel" background="#2e2e2e">
                    <div class="media profile-left">
                        <a class="pull-left profile-thumb" href="profile.html">
                            <img class="img-circle" src="images/photos/profile.png" alt="">
                        </a>
                      <div class="media-body">
                        <h4 class="media-heading">Olga De Troyer</h4>
                        <small class="text-muted"><strong>Status:</strong> Available in F.10.718</small></div>
                    </div><!-- media -->
                    
                    <h5 class="leftpanel-title">Navigation</h5>
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a href="index-2.html"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                        <li><a href="messages.html"><span class="pull-right fa-c">5</span><i class="fa fa-calendar"></i>My Schedule<span></span></a></li>
